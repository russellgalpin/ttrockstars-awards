...
<template>
    <div class="flex flex-col items-center flex-1 min-h-0">
        <!-- Progress -->
        <div class="w-full max-w-md text-center shrink-0">
        ...
        <!-- Question Display -->
        <div class="flex items-center justify-center gap-3 md:gap-5 select-none flex-1 min-h-0" v-if="currentQuestion">
        ...
        <div class="grid grid-cols-3 gap-2 w-full max-w-xs mx-auto shrink-0 pb-2">
            ...
            <button
                ...
                class="aspect-square text-2xl md:text-3xl font-bold rounded-xl bg-gray-200 text-gray-600 hover:bg-gray-300 active:bg-gray-400 transition-colors select-none shadow-sm touch-manipulation"
            >
                &#x232B;
            </button>
            ...
            <button
                @click="pressEnter"
                :class="[
                    'aspect-square text-xl md:text-2xl font-bold rounded-xl text-white transition-colors select-none shadow-sm touch-manipulation',
                    enterButtonColor,
                ]"
            >
                Enter
